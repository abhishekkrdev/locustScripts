...
import re
import locust.stats.CSV_STATS_INTERVAL_SEC=5
...
class UserBehaviour(TaskSet):
    ...
    def on_start(self):
        ...
        with self.client.post("/InsuranceWebExtJS/index.jsf", data={"login-form": "login-form", "login-form:email": "qamile2@gmail.com", "login-form:password": "abc123", "login-form:login.x": "57", "login-form:login.y": "9", "javax.faces.ViewState": self.viewstate}, headers=header,
