...
class UserBehaviour(SequentialTaskSet):
    ...
    def on_start(self):
        ...
        with self.client.post("/InsuranceWebExtJS/index.jsf", data={"login-form": "login-form", "login-form:email": "qamile2@gmail.com", "login-form:password": "abc123", "login-form:login.x": "57", "login-form:login.y": "9", "javax.faces.ViewState": "j_id1:j_id2"}, cookies={"JSESSIONID": self.jsession_id}, name="login", catch_response=True) as res:
